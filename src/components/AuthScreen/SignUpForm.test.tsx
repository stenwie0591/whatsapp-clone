...
describe('SignUpForm', () => {
  ...
  it('enables sign-up button when filled in', async () => {
    ...
    await wait(() => expect(nameInput.value).toEqual('User Name'));

    await wait(() => expect(usernameInput.value).toEqual('username'));

    await wait(() => expect(passwordInput.value).toEqual('password'));

    await wait(() => expect(passwordConfirmInput.value).toEqual('password'));

    await wait(() => expect(signUpButton.disabled).toEqual(false));
  });
